...
const Footer = ({ darkMode }) => {
  ...
  />
          ...
          >
            Kridana is a SaaS platform designed to solve everyday business challenges across B2B, B2C, and C2C ecosystems.
It helps businesses scale products, streamline operations, and drive revenue growth.
          </p>
