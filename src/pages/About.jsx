  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        ...
        >
          {/* About Kridana */}
          <h3 className="text-2xl md:text-3xl font-bold mb-5 text-[#8D5A3A]">
            About KRIDANA
          </h3>
          ...
          <h3 className="text-xl md:text-2xl font-bold mb-4 text-[#8D5A3A]">
            One Platform. Many Opportunities.
          </h3>
          ...
          {/* Backed By */}
          <h3 className="text-xl font-bold mb-3 text-[#8D5A3A]">
        ...
        <motion.div
          ...
          transition={{ duration: 1 }}
        >
          <h3 className="text-xl md:text-2xl font-bold mb-3 text-[#8D5A3A]">
            Our Vision
          </h3>
